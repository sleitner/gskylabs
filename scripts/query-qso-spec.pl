...
print "        <Icon>\n";
print "        <href>http://sky.astro.washington.edu/iconr.png</href>\n";
print "        </Icon>\n";
print "      </IconStyle>\n";
print "      <BalloonStyle>
