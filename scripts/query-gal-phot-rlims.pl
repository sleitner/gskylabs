...
my $magbound = $q->url_param('MLIM');
($mllim, $mulim) = split ',',$magbound;
if($mllim < 10){
    error_kml("bad magnitudes","Your magnitudes are screwed up",$mllim, $mulim);
}    
if(     $mllim == 16){ 
	$ic = "iconw";
  }	
...
print "      <scale>1</scale>\n";
print "        <Icon>\n";
#print "        <href>http://sky.astro.washington.edu/$ic.png</href>\n";
print "        <href>http://astrowiki.uchicago.edu/~sleitner/GS/images/$ic.png</href>\n";
print "        </Icon>\n";
print "      </IconStyle>\n";
print "      <BalloonStyle>
