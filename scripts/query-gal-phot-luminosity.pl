...
for $line (@lines){
  ...
  printf "    <description><table><tr><td><img height=\"30\" src=\"http://www.sdss.org/logos/SDSS_pi_bevel.gif\"/></td><td align=\"left\"><font size=\"40\">    SDSS</font></td></tr></table><b>$name</b><hr/><table><tr><td>RA:</td><td>%f</td></tr><tr><td> DEC:</td><td>%f</td></tr>\n",$x,$y;
  printf "    <tr><td>TYPE:</td><td>%s (%i)</td></tr>", $tstr, $type;
  printf "    <tr><td>MAGS:</td><td> g=%2.4f </td></tr><tr><td></td><td>r=%2.4f </td></tr><tr><td></td><td>i=%2.4f</td></tr><tr><td>Flux:</td><td>$flux</td></tr><tr><td>Photometric Redshift:</td><td>$redz</td></tr><tr><td>Photo-Z Error:</td><td>$zerr</td></tr></table><a href=\"http://cas.sdss.org/astro/en/tools/explore/obj.asp?id=$objid\">Click for SDSS Page</a><br/>Note: All magnitudes are model mags.\n",$g,$r,$i;
  print "    </description>\n";
