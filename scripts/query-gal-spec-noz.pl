...
for $line (@lines){
  ...
  printf "    <tr><td>MAGS:</td><td> g=%2.4f </td></tr><tr><td></td><td>r=%2.4f </td></tr><tr><td></td><td>i=%2.4f</td></tr><tr><td>redshift:</td><td>Determine this from Spectrum linked below.</td></tr></table>",$g,$r,$i;
